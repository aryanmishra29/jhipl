...
const Purchase: React.FC = () => {
    ...
    const fetchPurchaseOrders = async () => {
        try {
            const response = await axios.get(`${baseUrl}/purchase-orders/user/${user_id}`);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        formDataToSubmit.append('requisitionForm', formData.requisitionForm as Blob);
        formDataToSubmit.append('comparativeForm', formData.comparativeForm as Blob);
        ...
        try {
            const response = await axios.post(`${baseUrl}/purchase-orders/request`, formDataToSubmit, {
                headers: {
                ...
                <form onSubmit={handleSubmit}>
                    <div className="grid grid-cols-2 gap-6">
                        <div className="form-group">
                            <label htmlFor="requisitionForm" className="block font-bold mb-1">Requisition Form</label>
                            <input
                                type="file"
                                id="requisitionForm"
                        ...
                        <div className="form-group">
                            <label htmlFor="comparativeForm" className="block font-bold mb-1">Comparative Form</label>
                            <input
                                type="file"
                                id="comparativeForm"
                        ...
                        <div className="form-group">
                            <label htmlFor="quotation1" className="block font-bold mb-1">Requisition Form</label>
                            <input
                                type="file"
                                id="quotation1"
                                name="quotation1"
                        ...
                        <div className="form-group">
                            <label htmlFor="quotation2" className="block font-bold mb-1">Comparative Form</label>
                            <input
                                type="file"
                                id="quotation2"
                                name="quotation2"
                        ...
                        <div className="form-group">
                            <label htmlFor="quotation3" className="block font-bold mb-1">Requisition Form</label>
                            <input
                                type="file"
                                id="quotation3"
                                name="quotation3"
                    ...
                    <button type='submit' className='bg-green-600 flex justify-center w-full max-w-sm px-6 py-2 rounded-lg'>Submit</button>
                </form>
            </Modal>
        </div>
    )
